...
<?php     if(($_SESSION['cat']=="photo")){
    ...
    <div class="restaurant">
       ...
       ?>
         ...
         <a href="finalupdating.php?id=<?php echo $rows['id'];  ?>"><img src='uploads/<?php echo $rows['photo']; ?>'  alt="pic">
      ...
      <a href="finalupdating.php?id=<?php echo $rows['id'];  ?>"><p style="margin:10px;text-align:center; ">Content:<?php   echo $rows['content1']  ?></p></a>
           ...
           <hr/>
            ...
            <?php     if(($_SESSION['cat']=="qanda")){
              ...
              <div class="data">
  <a href="finalupdating.php?id=<?php echo $rows['id'];  ?>">
