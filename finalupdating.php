...
<?php     if(($_SESSION['cat']=="photo")){
  ...
  <p style="text-align:center;">Photo's Are Not Updatable</p>
  ...
  <?php
   ...
   <form class="" action="finalupdate.php" method="post">



    <input type="text" name="note" value="<?php   echo $rows['content1']  ?>" required>
  ...
  <input type="submit" name="noteupdate" value="update">
           ...
           <hr/>
            ...
            <?php     if(($_SESSION['cat']=="qanda")){
              ...
              <input type="text" name="question" value="<?php   echo $rows['content1']  ?>" required>
              <input type="text" name="answer" value="<?php   echo $rows['content2']  ?>" required>
  ...
  <input type="submit" name="qandaupdate" value="update">
                ...
                <input type="text" name="link" value="<?php   echo $rows['content1']  ?>" required>
                <input type="text" name="discription" value="<?php   echo $rows['content2']  ?>" required>
    ...
    <input type="submit" name="videoupdate" value="update">
