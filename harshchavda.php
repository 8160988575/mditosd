...
<div class="container">
  ...
  <div class="category">
    ...
    <ul>
      <li><a href="3page.php?name=gallery&site=<?php echo $_GET['id']  ?>">Add Something</a></li>
      <li><a href="3page.php?name=booklet&site=<?php echo $_GET['id']  ?>">Delete Something</a></li>
      <li><a href="3page.php?name=special&site=<?php echo $_GET['id']  ?>">Add New Site</a></li>
      <li><a href="3page.php?name=offer&site=<?php echo $_GET['id']  ?>">Delete Site</a></li>
